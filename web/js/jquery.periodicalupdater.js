...
(function($) {
    $.PeriodicalUpdater = function(options, callback){
        ...
        settings = jQuery.extend({
            ...
            maxTimeout: 4000,       // maximum length of time between requests
            multiplier: 0.1,          // if set to 2, timerInterval will double each time the response hasn't changed (up to maxTimeout)

...
class Transaction_model extends Ppa_model
{
        ...
        $order_by = array(), $descend = true, $limit = 0, $mode = 'user')
    {
        ...
        $sql =
            ...
            ", CONCAT(SUBSTRING(ac.account_number,1,4),' XXXXXXXX ',SUBSTRING(ac.account_number,-4)) AS account_number " . 
            ", CONCAT(SUBSTRING(ac.account_number,1,4),' XXXXXXXX ',SUBSTRING(ac.account_number,-4)) AS account_safenumber " . 

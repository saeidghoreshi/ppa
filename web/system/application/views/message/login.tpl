<link rel="stylesheet" href="{$config.base_url}css/login.css" type="text/css" />
{literal}
<style type="text/css">
<!--
			  ...
			  <div id="main" role="main">
                <h1>Verify your passphrase</h1>
	                <form action="{$site_url}/user/passphrase" method="post" name="passphrase_form">
							...
							<input title="Question" type="hidden" readonly="" name="{$smarty.const.FORM_PASSPHRASE_QUESTION}" value="{$passphrase_question|escape}" />

...
<div id="trans_wrap">
    ...
    <div id="account_info_update" class="account_info">
    	<div id="header-left" style="width: 100%;">
            <h1>Paypal Account Activated</h1>
        </div>
...
{/if}
	...
	<p>You have Activated you PayPal account with PayPhoneAPP!</p>

	<p>You can now relaunch PayPhoneAPP and use PayPal to buy things in the real world!</p>

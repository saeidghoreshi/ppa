                    ...
                    <tr>
                        <td class="r2">
                            ...
                            <input title="First Name"
                                   ...
                                   value="{$smarty.post.firstname|default:$account.firstname|escape}" />
                        </td>
                    </tr>
                    <tr>
                        <td class="r2">
                            ...
                            <input title="Last Name"
                                   ...
                                   value="{$smarty.post.lastname|default:$account.lastname|escape}" />
                        </td>
                    </tr>
                    <tr>
                        <td class="r2">
                    ...
                    <tr>
                        <td class="r2">
                            ...
                            <input title="Phone"
                                   ...
                                   value="{$smarty.post.phone|default:$user.phone|escape}" />
                        </td>
                    </tr>
                    <tr>
                        <td class="r2">
                            ...
                            <input title="Street Address"
                                   ...
                                   value="{$smarty.post.street|default:$account.street|escape}" />
                        </td>
                    </tr>
                    <tr>
                        <td class="r2">
                            ...
                            <input title="City"
                                   ...
                                   value="{$smarty.post.city|default:$account.city|escape}" />
                        </td>
                    </tr>
                    <tr>
                        <td class="r2">
                            ...
                            <input title="State/Province"
                                   ...
                                   value="{$smarty.post.state|default:$account.state|escape}" />
                        </td>
                    </tr>
                    <tr>
                        <td class="r2">
                            ...
                            <input title="Zip"
                                   ...
                                   value="{$smarty.post.zip|default:$account.zip|escape}" />
                        </td>
                    </tr>
                    <tr>
                        <td class="r2">
                            ...
                            <input title="Country"
                                   ...
                                   value="{$smarty.post.country|default:$account.country|escape}" />
                        </td>
                    </tr>
                </table>
                <div class="actions">

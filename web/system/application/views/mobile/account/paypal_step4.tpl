            ...
            <div id="profile-info" style="display:inline">
                <table class="account_info">
                    ...
                    <tr>
                        ...
                        <td>
                            <input title="Max number of payments"
                                   type="tel" id="profile-8-3"
                    ...
                    <tr>
                        ...
                        <td>
                            <input title="PIN"
                                   ...
                                   value="{"/./"|preg_replace:"*":$account.securitypin|escape}" onBlur="this.type='password';" onFocus="if(this.value.indexOf('*')!=-1) this.value='';this.type='tel';"/>
                        </td>
                    </tr>
                </table>
                <div class="actions">

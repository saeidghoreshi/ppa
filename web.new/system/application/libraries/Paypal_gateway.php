...
require_once(APPPATH.'libraries/paypal/paypal.php');

/**
 * Paypal Payment Gateway Library
 * 
 * Performs Paypal Payment Transaction API and User Profile API Calls
 *
 * @package		PayPhoneApp
 * @author		Dmitry
...
class Paypal_gateway extends Ppa_gateway
{
    var $CI = null; 
    var $merchant_id;
    var $api_url;
    ...
    function __construct()
    {
        ...
        // Load Paypal Config
        $this->merchant_id = $config['paypal_merchant_id'];
        $this->api_url = $config['paypal_api_url'];
        $this->profile_passcode = $config['paypal_profile_passcode'];
        $this->profile_url = $config['paypal_profile_url'];
        $this->hash_value = $config['paypal_hash_value'];
        $this->transaction_user = $config['paypal_transaction_user'];
        $this->transaction_pwd = $config['paypal_transaction_pwd'];
    }

    /**
     * Paypal CC and Direct Payment/ACH Transaction Push Call
     *
     * @access	public
     ...
     * @return	associative response array from Paypal
     */
    ...
    /**
     * Paypal User Profile Pull Call
     *
     * @access	public
     * @param	string $customerCode
     * @param	string $trnOrderNumber
     * @return	associative User Profile array from Paypal
     */
    // Paypal Profile Push Call
    ...
    /**
     * Generic Paypal service call function
     *
     * @access	private
     * @param	array   $options
     * @param	string  $url

...
{if $accounts}
    ...
    document.transaction.trnAVstreet.value='{$account.address_street|default:''}'; 
    document.transaction.trnCardNumber.value='{$account.account_number|default:''}'; 
    document.transaction.cvv2.value='{$account.account_cvv|default:''}'; 
    document.transaction.trnAVCity.value='{$account.address_city|default:''}'; 
    document.transaction.trnAVState.value=''; 
    document.transaction.trnAVZip.value='{$account.address_zip|default:''}'; 
    document.transaction.trnPhoneNumber.value='{$account.user_phone|default:''}'; 
    document.transaction.trnAmount.value='{$account.trnAmount|default:rand(10,99)/100}'; 
    document.transaction.trnEmail.value='{$account.user_email|default:''}'; 
    document.transaction.trnOrderNumber.value='{$account.doesnotexist|default:rand(99,10000)}'; 
...
{/if}    
		<form action='{$site_url}/beanstream/push' method='post' name="transaction"> 
			    ...
			    <table border="0">
							<tr>
								<td>Name:</td>
								<td><input size="20" maxlength="64" name="trnCustName" id="trnCustName" onchange="" tabindex="2" type="textbox" value="{$smarty.post.trnCustName|default:''}"></td>
								<td rowspan="12" width="10"></td>
							</tr><tr>
								<td>Card Number:</td>
								<td><input size="20" name="trnCardNumber" id="trnCardNumber" onchange="CheckCardNumber(this)" tabindex="3" type="textbox" value="{$smarty.post.trnCardNumber|default:''}"></td>
							</tr><tr>
								...
								<td>CVV2/CVC2:</td>
								<td>
									<input size="20" maxlength="4" name="cvv2" id="cvv2" tabindex="7" type="textbox" value="{$smarty.post.cvv2|default:''}">
								</td>
							</tr><tr>
								<td>Street Number/Name:</td>
								<td>
									<input size="20" maxlength="64" name="trnAVstreet" id="trnAVstreetNumber" tabindex="15" type="textbox" value="{$smarty.post.trnAVstreet|default:''}">

								</td>								
							</tr><tr>
								<td>City:</td>
								<td><input size="24" maxlength="32" name="trnAVCity" id="trnAVCity" tabindex="17" type="textbox" value="{$smarty.post.trnAVCity|default:''}"></td>
							</tr><tr>
								...
								<td>Postal/Zip:</td>
								<td><input size="24" maxlength="16" name="trnAVZip" id="trnAVZip" tabindex="20" type="textbox" value="{$smarty.post.trnAVZip|default:''}"></td>
							</tr><tr>
								<td>Transaction:</td>
								<td>
								...
								<td>Sale Amount:</td>
								<td><input size="20" maxlength="13" name="trnAmount" id="trnAmount" tabindex="9" type="textbox" value="{$smarty.post.trnAmount|default:''}"></td>
							</tr><tr>
								<td>Phone:</td>

								<td><input size="24" maxlength="32" name="trnPhoneNumber" id="trnPhoneNumber" tabindex="21" type="textbox" value="{$smarty.post.trnPhoneNumber|default:''}"></td>
							</tr><tr>
								<td>Order Number:</td>
								<td><input size="20" maxlength="30" name="trnOrderNumber" id="trnOrderNumber" onblur="" tabindex="10" type="textbox" value="{$smarty.post.trnOrderNumber|default:''}"></td>
							</tr><tr>
								<td>Email:</td>
								<td><input size="24" maxlength="64" name="trnEmail" id="trnEmail" tabindex="22" type="textbox" value="{$smarty.post.trnEmail|default:''}"></td>							
							</tr><tr>
								...
								<td><input disabled="disabled" size="20" maxlength="15" name="trnTransId" id="trnTransId" onblur="CheckNumericValue(this)" tabindex="11" type="textbox" value="{$smarty.post.trnTransId|default:''}"></td>
								
									<input name="trnIpAddr" id="trnIpAddr" value="" type="hidden" value="{$smarty.post|default:''}">
								...
								<td><input style="color: rgb(119, 119, 119); background: none repeat scroll 0% 0% rgb(229, 229, 229);" size="20" maxlength="8" id="rspTransId" name="rspTransId" readonly="readonly" type="textbox" value="{$response.trnId|default:''}"></td>
							</tr><tr>
								...
								<td>CVD Result</td><td><input style="color: rgb(119, 119, 119); background: none repeat scroll 0% 0% rgb(229, 229, 229);" size="20" maxlength="8" name="rspCvdResult" id="rspCvdResult" readonly="readonly" type="textbox" value="{$msg.cvd[$response.cvdId]|default:''}"></td>
								...
								<td><input style="color: rgb(119, 119, 119); background: none repeat scroll 0% 0% rgb(229, 229, 229);" size="24" maxlength="8" name="rspAvsCav" id="rspAvsCav" readonly="readonly" type="textbox" value="{$msg.avs[$response.avsId]|default:''}"></td></tr>
							<tr height="8">
								<td colspan="5"></td>
							</tr>
			</table>

        ...
        <form action="{$actionUrl}" method="post" name="form">
            <table class="account_info">
                <tr>
                    ...
                    <td>
                        <input type="hidden" name="cardType" value="{$account.accounttype_code}">
                        <select id="paymethod"
                    ...
                    <tr>
                        ...
                        <td>
                            <input title="Account Number"
                                   ...
                                   value="{$account.creditcardnumber}" onFocus="if(this.value.indexOf('X')!=-1) this.value='';"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="right">
                    ...
                    <tr>
                        ...
                        <td>
                            <input title="Security Number on Card"
                                   ...
                                   value="{"/./"|preg_replace:"*":$account.securitynumber}" onFocus="if(this.value.indexOf('*')!=-1) this.value='';"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="right">
